...
class _PedidoRenglonListState extends State<PedidoRenglonList> {
  ...
  List<PedidoRenglonEspera> _pedidosRenglones = [];
  ...
  void initState() {
    ...
    _loadPedidosRenglonesdb(widget.pedidoSelected.numero);
  }

  /*
  Future<void> _fetchPedidoRenglon(String numeroPedido) async {
    final response = await http.get(
      Uri.parse('https://nodejs-mysql-railway-production-3789.up.railway.app/PedidosRenglones/$numeroPedido')
    );
  ...
  */
  ...
  Future<void> _loadPedidosRenglonesdb(String numeroPedido) async {
    List<PedidoRenglonEspera> pedidoRenglonEspera = await _databaseHelper.getPedidosRenglonesEspera(numeroPedido);

    setState(() {
      _pedidosRenglones = pedidoRenglonEspera;
    });
  }
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                final PedidoRenglonEspera renglon = _pedidosRenglones[index];
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                '${renglon.cantidad.toStringAsFixed(0)}',
                                style: TextStyle(
                                  fontSize: 15,
                                ),
                                textAlign: TextAlign.center,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                //'${double.parse(renglon['Despacho']).toStringAsFixed(0)}',
                                '0',
                                style: TextStyle(
                                  fontSize: 15,
                                ),
                        ...
                        */
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                '${renglon.precioMoneda.toStringAsFixed(2)}',
                                style: TextStyle(
                                  fontSize: 15,
                                ),
                                textAlign: TextAlign.right,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                '${renglon.totalRenglon.toStringAsFixed(2)}',
                                style: TextStyle(
                                  fontSize: 15,
                                ),
                                textAlign: TextAlign.right,
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(child: 
                      ExpandableText(
                        '${widget.pedidoSelected.comentario} / Días de Crédito: ${widget.pedidoSelected.diasCredito}',
                        style: TextStyle(
                          fontSize: 16,
                        ),
